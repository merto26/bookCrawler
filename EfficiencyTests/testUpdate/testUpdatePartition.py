...
def testeUpdatePartition(num_repeats):
    ...
    graphCreator.createStackedBarGraph(x=["with partition","without partition"], y1=mysql_times, y2=mongo_times)