...
mySQLQuery2 = """
            UPDATE books
            SET price_with_tax = CAST(price_with_tax AS DECIMAL(10,2)) * 1
            WHERE title LIKE 'Book%'
              AND genre = 'Science Fiction'
              AND CAST(price_with_tax AS DECIMAL(10,2)) BETWEEN 10 AND 30
              AND CAST(availability AS UNSIGNED) > 0;
"""
...
datamodell_mysql_configs = [
    {'host': 'localhost', 'user': 'root', 'password': 'bettkante12345!', 'database': 'testDB_1', 'query': mySQLQuery1},
    {'host': 'localhost', 'user': 'root', 'password': 'bettkante12345!', 'database': 'testDB_2', 'query': mySQLQuery1},
    {'host': 'localhost', 'user': 'root', 'password': 'bettkante12345!', 'database': 'testDB_3', 'query': mySQLQuery1},
    {'host': 'localhost', 'user': 'root', 'password': 'bettkante12345!', 'database': 'testDB_4', 'query': mySQLQuery1},
    {'host': 'localhost', 'user': 'root', 'password': 'bettkante12345!', 'database': 'testDB', 'query': mySQLQuery1}
]

mysql_configs = [
    {'host': 'localhost', 'user': 'root', 'password': 'bettkante12345!', 'database': 'modellingTestDB_1', 'query': mySQLQuery1},
    {'host': 'localhost', 'user': 'root', 'password': 'bettkante12345!', 'database': 'modellingTestDB_2', 'query': mySQLQuery1},
    {'host': 'localhost', 'user': 'root', 'password': 'bettkante12345!', 'database': 'modellingTestDB_3', 'query': mySQLQuery1},
    {'host': 'localhost', 'user': 'root', 'password': 'bettkante12345!', 'database': 'modellingTestDB_4', 'query': mySQLQuery1},
